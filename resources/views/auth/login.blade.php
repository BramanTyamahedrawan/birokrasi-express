...
<head>
    ...
    <title>Login Birokrasi Express</title>
                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="#" class="app-brand-link gap-2">
                                <span class="app-brand-text demo fw-bolder">LOGIN</span>
                            </a>
                        </div>
                        <!-- /Logo -->
                        <h4 class="mb-2">Welcome to Birokrasi Express 👋</h4><br>
                        ...
                        <div class="mb-3">
                            <a href="{{ route('home') }}"> <button class="btn btn-primary d-grid w-100"
