...
>
  <head>
    ...
    <title>Register Birokrasi Express</title>
            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="#" class="app-brand-link gap-2">
                  <span class="app-brand-text demo fw-bolder">REGISTER</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Silakan Buat Akun 🚀</h4>
              <p class="mb-4">Make your app management easy and fun!</p>
                ...
                <a href="{{ route('home') }}"><button class="btn btn-primary d-grid w-100">Sign up</button></a>
